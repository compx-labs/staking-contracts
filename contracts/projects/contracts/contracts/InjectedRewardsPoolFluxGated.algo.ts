...
export class InjectedRewardsPoolFluxGated extends Contract {
  ...
  fluxTierRequired = GlobalStateKey<uint64>();

  fluxOracleAppId = GlobalStateKey<uint64>();
   ...
   */
  initApplication(stakedAssetId: uint64, rewardAssetId: uint64, initialBalanceTxn: PayTxn, fluxTierRequired: uint64, fluxOracleAppId: uint64): void {
    ...
    this.fluxTierRequired.value = fluxTierRequired;
