...
describe('Permissionless Injected Reward Pool setup/admin functions - no staking', () => {
  ...
  test.skip('Send Rewards x1', async () => {
  ...
  test.skip('Send Rewards x2', async () => {
  ...
  test.skip('Send ASA rewards from admin', async () => {
  ...
  test('Send rewards directly to application from staker 2 account', async () => {
    const rewardSender = stakers[1].account;
    fixture.algorand.account.setSignerFromAccount(rewardSender);
  ...
  test.skip('Staker 1 claim rewards', async () => {
  ...
  test('staker 2 unstake', async () => {
    ...
    console.info('Stake token balance change', {
      before: stakeTokenBalanceBefore,
      after: stakeTokenBalanceAfter,
    });
    console.info('App Algo balance change', {
      before: appAlgoBalanceBefore,
      after: appAlgoBalanceAfter,
    });
    console.info('xUSD token balance change', {
      before: xUSDTokenBalanceBefore,
      after: xUSDTokenBalanceAfter,
    });
    console.info('Reward token balance change', {
      before: RewardTokenBalanceBefore,
      after: RewardTokenBalanceAfter,
    });
  });
